...
# Inject Custom PHYSIQ-inspired CSS Styling
st.markdown("""
<style>
    ...
    .stApp {
        ...
        background-image: radial-gradient(circle at 10% 20%, rgba(139, 92, 246, 0.12) 0%, transparent 60%),
                          radial-gradient(circle at 90% 80%, rgba(6, 182, 212, 0.12) 0%, transparent 60%) !important;
    }

    /* Custom Fonts globally */
    html, body, [class*="css"], .stMarkdown, p, h1, h2, h3, h4, h5, h6, span, label, li {
        font-family: 'Outfit', 'Inter', sans-serif !important;
    }

    /* Header Titles styling */
    h1 {
        background: linear-gradient(180deg, #ffffff 0%, #a5b4fc 100%) !important;
    ...
    h2, h3 {
        color: #c3bef7 !important;
        font-weight: 600 !important;
    }

    /* Glassmorphic Metrics */
    div[data-testid="metric-container"] {
        background: rgba(15, 17, 28, 0.45) !important;
    ...
    div[data-testid="stTable"] table {
        background-color: rgba(15, 17, 28, 0.3) !important;
    ...
    div[data-testid="stExpander"] {
        background: rgba(15, 17, 28, 0.3) !important;
